...
import { deepOrange, brown, common } from "@material-ui/core/colors";
...
const brown50 = brown["50"];
const darkWhite = common.white;
...
/* Material-UI theme */
const flybraryTheme = createMuiTheme({
  ...
  appBar: {
    // FIXME titleFontWeight: typography.fontWeightLight,
  },
  card: {
    // FIXME fontWeight: typography.fontWeightLight,
  },
});
...
class App extends Component {
  ...
  render() {
    ...
    return (
      <ThemeProvider theme={flybraryTheme}>
        <div className="App">
          <TopBar
          ...
          <Snackbar
            ...
            message={
              snackbarData.shelf
                ? `${
                    getWidth() === widths.wide ? snackbarData.title : "Book"
                  } added to ${shelfData.getShelfWithWidth(
                    snackbarData.shelf
                  )}!`
                : ""
            }
